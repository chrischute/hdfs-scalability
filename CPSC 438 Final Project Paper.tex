...
\begin{abstract}
	This paper explores the scalability limits of the Hadoop Distributed File System (HDFS). The single-machine, in-memory metadata store of HDFS is a known bottleneck for applications requiring storage of many small files. However, this architecture presents other theoretical bottlenecks including various CPU load on the NameNode. 
\end{abstract}
\begin{multicols*}{2}
