...
We found that there was no decrease in throughput as more files were added. This supports the HDFS design assumption that metadata operations are relatively inexpensive. Moreover, it does not support the hypothesis that disk seeks on random file access are more expensive when more files were added.

\subsection{Experiment 4: Write Throughput}

\subsection{Experiment 5: CPU Bottleneck}
