...
\end{center}
We see that there is an initial spike in throughput as the number of the utilization of the DataNodes increases. In the case of reads, there is a moderate decrease in the number of connections beyond 8. This is likely due to the fact that random reads involve disk seeks between each 
